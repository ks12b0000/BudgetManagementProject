...
## 프로젝트 기간 
2023-11-09 ~ 2023-11-16 (종료 예정 현재 진행 중)
...
<summary>Expenditures - click</summary>
  ...
  - Expenditure 추천
      ...
      - 매일 08:00 시 유저에게 알림을 발송해 오늘의 지출 추천 내용을 보내줍니다.
          - 모든 유저한테 알림을 발송할 수 있게 위 로직을 가져와 사용할 수 있는 스케줄러를 사용한 코드를 만들어 모든 유저의 맞는 상황에 따라 지출 추천 내용을 발송 해줄 수 있도록 설정하였습니다.
          - ex) <img width="300" alt="스크린샷 2023-11-15 오후 11 30 49" src="https://github.com/ks12b0000/BudgetManagementProject/assets/102012155/d6b8953e-21fc-4fd7-8422-195d225cfc53">
  - Expenditure 안내(완료 후 작성 아직 진행 중)
